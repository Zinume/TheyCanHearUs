...
func coneccionesConPlayerMic():
	player.jugadorHablancoPorMic.connect(signalDelMicJugadorHablando)
	player.jugadorNoHablaPorMic.connect(signalDelMicJugadorCallando)
	player.jugadorEstaGritandoPorMic.connect(signalDelMicJugadorGritando)
